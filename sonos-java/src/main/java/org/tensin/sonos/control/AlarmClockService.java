...
public class AlarmClockService extends AbstractService {
    ...
    /**
     * Instantiates a new alarm clock service.
     *
     * @param upnpService the upnp service
     * @param service the service
     */
    protected AlarmClockService(final UpnpService upnpService, final Service service) {
        super(upnpService, service, ZonePlayerConstants.SONOS_SERVICE_ALARM_CLOCK);
    }

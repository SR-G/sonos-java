...
public class AudioInService extends AbstractService {
    ...
    public AudioInputAttributes getAudioInputAttributes()  {
        SonosActionInvocation message = messageFactory.getMessage(getService(), "GetAudioInputAttributes");
    ...
    public LineLevel getLineInLevel()  {
        SonosActionInvocation message = messageFactory.getMessage(getService(), "GetLineInLevel");
        executeImmediate(message);

        return new LineLevel(Integer.parseInt(message.getOutputAsString("CurrentLeftLineInLevel")), Integer.parseInt(message
                .getOutputAsString("CurrentRightLineInLevel")));
    }
    ...
    public void setAudioInputAttributes(final String name, final String iconUri)  {
        SonosActionInvocation message = messageFactory.getMessage(getService(), "SetAudioInputAttributes");
    ...
    public void setLineInLevel(final int leftLevel, final int rightLevel)  {
        SonosActionInvocation message = messageFactory.getMessage(getService(), "SetLineInLevel");
    ...
    public String startTransmissionToGroup(final String groupId)  {
        SonosActionInvocation message = messageFactory.getMessage(getService(), "StartTransmissionToGroup");
    ...
    public void stopTransmissionToGroup(final String groupId)  {
        SonosActionInvocation message = messageFactory.getMessage(getService(), "StopTransmissionToGroup");
        message.setInput("CoordinatorID", groupId);
        execute(message);
    }
}

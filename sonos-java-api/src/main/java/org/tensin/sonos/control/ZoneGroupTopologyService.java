...
//		public void handleStateVariableEvent(final String varName,
...
//
	 ...
	 *            the service
	 */
	public ZoneGroupTopologyService(final UpnpService upnpService,
	...
	/**
	 * registers the given listener to be notified of changes to the state of
	 * the AVTransportService.
	 *
	 * @param l
	 *            the l
	 */
	...
	/*
	 * <stateVariable sendEvents="no"> <name>A_ARG_TYPE_UpdateType</name>
	 * <dataType>string</dataType> <allowedValueList>
	 * <allowedValue>All</allowedValue> <allowedValue>Software</allowedValue>
	 * </allowedValueList> </stateVariable> <stateVariable sendEvents="no">
	 * <name>A_ARG_TYPE_CachedOnly</name> <dataType>boolean</dataType>
	 * </stateVariable> <stateVariable sendEvents="no">
	 * <name>A_ARG_TYPE_UpdateItem</name> <dataType>string</dataType>
	 * </stateVariable> <stateVariable sendEvents="no">
	 * <name>A_ARG_TYPE_UpdateURL</name> <dataType>string</dataType>
	 * </stateVariable> <stateVariable sendEvents="no">
	 * <name>A_ARG_TYPE_UpdateFlags</name> <dataType>ui4</dataType>
	 * </stateVariable> <stateVariable sendEvents="no">
	 * <name>A_ARG_TYPE_Version</name> <dataType>string</dataType>
	 * </stateVariable> <stateVariable sendEvents="no">
	 * <name>A_ARG_TYPE_MemberID</name> <dataType>string</dataType>
	 * </stateVariable> <stateVariable sendEvents="no">
	 ...
	 *            the update url
	 * @param updateFlags
	 *            the update flags @ Signals that an I/O exception has occurred.
	 */
	public void beginSoftwareUpdate(final String updateUrl,
			final int updateFlags) {
		SonosActionInvocation message = messageFactory.getMessage(getService(),
				"BeginSoftwareUpdate");
	 ...
	 * @param version
	 *            the version
	 * @return the string @ Signals that an I/O exception has occurred.
	 */
	public String checkForUpdate(final UpdateType type,
			final boolean cachedOnly, final String version) {
		SonosActionInvocation message = messageFactory.getMessage(getService(),
				"CheckForUpdate");
	...
	/*
	 * <action> <name>ReportAlarmStartedRunning</name> </action>
	 */
	...
	public ZoneGroupState getGroupState() {
		...
		// StateVariableMessage groupMessage =
		// messageFactory.getStateVariableMessage(
		// ZonePlayerConstants.SONOS_VARIABLE_ZONE_GROUP_STATE );
		// try {
		// StateVariableResponse resp = groupMessage.service();
		// zoneGroup =
		// ResultParser.getGroupStateFromResult(SonosController.getInstance(),
	...
	/**
	 * unregisters the given listener: no further notifications shall be
	 * recieved.
	 *
	 * @param l
	 *            the l
	 */
	public void removeZoneGroupTopologyListener(
			final ZoneGroupTopologyListener l) {
		synchronized (listeners) {
			listeners.remove(l);
		}
	}
	 ...
	 *            the device uuid
	 * @param action
	 *            the action @ Signals that an I/O exception has occurred.
	 */
	public void reportUnresponsiveDevice(final String deviceUuid,
			final UnresponsiveDeviceActionType action) {
		SonosActionInvocation message = messageFactory.getMessage(getService(),
